...
```
With our optimal parameter setting, the model achieves a testing $R^2$ of 0.948, indicating strong predictive ability, and a testing RMSE of 2822.49, suggesting that on the unseen data the average prediction error in medical costs is approximately 2,800 USD.
...
We can say the performance of this model is quite well.
